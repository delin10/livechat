...
import nil.ed.livechat.chatroom.util.sensitive.seg.impl.WordSegmenterImpl;
...
public class SegmentSensitiveFilterTest {
    ...
    public void test()  {
        Function<List<String>, SensitiveFilter> constructor = lib ->
                new SegmentSensitiveFilter(new TierTreeMatcher(
                        AbstractLevelMatcher.MatchLevel.NORMAL, lib), new WordSegmenterImpl());
